...
class AdministrationController {
    public static loadMenu = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    public static loadColumns = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        const data = req.body;
    ...
    public static loadTableData = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
